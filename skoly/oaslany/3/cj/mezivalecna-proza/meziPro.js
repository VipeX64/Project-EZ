...
const database = [
    ...
    { questionInput: "Které z těchto děl patří mezi fantasticko-utopické romány od Karla Čapka?", answerA: "Továrna na absolutno", answerB: "Tisíc a jedna noc", answerC: "Vítězná hvězda", answerD: "Bylo nás 5", correctRank: 1, used: false },
    ...
    { questionInput: "Karel Čapek působil od r. 1921 v jakých novinách?", answerA: "Lidové noviny", answerB: "Tisk lidu", answerC: "Praha dnes", answerD: "Deník Litera", correctRank: 1, used: false },
    { questionInput: "V jakém roce končí 1. vývojové období Karla Čapka?", answerA: "1918", answerB: "1921", answerC: "1929", answerD: "1938", correctRank: 2, used: false },
    { questionInput: "Co je charakteristické pro 3. vývojové období Karla Čapka, tedy v letech 1928 - 1933", answerA: "Cestopisy", answerB: "Horrory a detektivky", answerC: "Krátké povídky, fejetony a sloupky", answerD: "Citově zabarvené básně, milostná a přírodní tématika", correctRank: 3, used: false },
    ...
    // konec Čapka
    { questionInput: "Který z těchto výroků NENÍ PRAVDIVÝ o Karlu Poláčkovi?", answerA: "Pocházel z východní Čech, z židovské rodiny", answerB: "Roku 1914 bojoval na frontě 1. sv. války", answerC: "Zahynul v koncentračním táboře Osvětim", answerD: "Dostal nobelovu cenu za literaturu", correctRank: 4, used: false },
